# 💰 SimpleMoney & SimpleBuilding
**(Mod ID: `simplemoney` / `simplebuilding`)**
...
| **3. Assembly** | **Banknote Blank** | **Smithing Table** | Combine Paper and Fiber using an **Iron Ingot** template. |
| **4. Printing** | **Raw Bill** | Crafting | Dye the blank note using **Green Dye** and **Ink Sacs**. |
| **5. Curing** | **Money Bill** | **Blast Furnace** | Fire the wet bill to finalize it (Fireproof & Glowing). |

![Crafting Recipe:](https://cdn.modrinth.com/data/cached_images/fdcc0be943d81e67530bdae7d264f67cbf00483d.png)
![Crafting Recipe:](https://cdn.modrinth.com/data/cached_images/a2a4683b23b92639a397813640fee81e815347bc.png)
![Crafting Recipe:](https://cdn.modrinth.com/data/cached_images/e7efb98ea521022737b6c637e61c030484d40881.png)
![Crafting Recipe:](https://cdn.modrinth.com/data/cached_images/988b67f36882918519f6cff1f55c877689a0bc3d.png)
![Crafting Recipe:](https://cdn.modrinth.com/data/cached_images/89c66613f5e70c340a1b5077578b51b2f9a3f682.png)
